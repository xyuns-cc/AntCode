...
class SelectorList(list):
    ...
    def attrib(self, name: str, default: str = None) -> Optional[str]:
        """获取第一个属性"""
...
class Selector:
    ...
    def xpath(self, query: str) -> SelectorList:
        ...
        if isinstance(result, list):
            return SelectorList([
                Selector(root=item, type=self._type) if isinstance(item, HtmlElement) or hasattr(item, 'xpath')
    ...
    def extract_first(self, default: str = None) -> Optional[str]:
        """提取第一个 HTML"""
