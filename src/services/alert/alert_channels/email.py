...
from src.services.alert.alert_channels.base import AlertChannel
...
"""
    ...
    async def send_alert_with_fallback(self, message: str, level: str, default_levels: List[str]) -> bool:
        """发送告警（带级别过滤）"""
