...
class DefaultValueFallback(FallbackStrategy[T]):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        self._stats.fallback_reasons[reason] = self._stats.fallback_reasons.get(reason, 0) + 1
    ...
    def decorator(func: Callable[..., T]) -> Callable[..., T]:
        ...
        def sync_wrapper(*args: Any, **kwargs: Any) -> T:
            try:
                ...
                return asyncio.get_event_loop().run_until_complete(strategy.execute(e, *args, **kwargs))
