...
class AlertConfigRequest(BaseModel):
    ...
    auto_alert_levels: list[str] = Field(default_factory=list, description="自动告警级别")
    rate_limit: AlertRateLimitConfig = Field(default_factory=AlertRateLimitConfig)
    retry: AlertRetryConfig = Field(default_factory=AlertRetryConfig)
