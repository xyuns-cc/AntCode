...
// 读回失败的类别（后端 worker_snapshot.py 的 SnapshotErrorReason）。
// 两种坏法的处置完全不同，所以走枚举，不许去 match message 里的中文。
export type SnapshotErrorReason = 'field_mismatch' | 'not_an_object'
