...
def check_service_boundary_violations(service_name: str, service_path: str) -> list[ServiceBoundaryViolation]:
...
class TestServiceBoundary:
    ...
    def test_web_api_boundary(self):
        ...
        **Validates: Requirements 4.5**
        ...
        if violations:
            violation_report = "\n".join(
                f"  - {v.file_path}:{v.line_number}: {v.import_statement}\n    Cannot import from: {v.target_service}"
                for v in violations
            )
            pytest.fail(f"web_api has {len(violations)} service boundary violations:\n{violation_report}")
    ...
    def test_master_boundary(self):
        ...
        **Validates: Requirements 5.4**
        ...
        if violations:
            ...
            pytest.fail(f"master has {len(violations)} service boundary violations:\n{violation_report}")
    ...
    def test_gateway_boundary(self):
        ...
        **Validates: Requirements 4.5, 5.4**
        ...
        if violations:
            ...
            pytest.fail(f"gateway has {len(violations)} service boundary violations:\n{violation_report}")
    ...
    def test_worker_boundary(self):
        ...
        **Validates: Requirements 4.5, 5.4**
        ...
        if violations:
            ...
            pytest.fail(f"worker has {len(violations)} service boundary violations:\n{violation_report}")
    ...
    def test_all_services_boundary_compliance(self):
        ...
        **Validates: Requirements 4.5, 5.4**
        ...
        if all_violations:
            ...
            pytest.fail(f"Found {len(all_violations)} service boundary violations:\n{violation_report}")
