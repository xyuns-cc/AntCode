...
def check_import_boundary_violations(service_name: str, service_path: str) -> list[ImportViolation]:
    ...
    def test_all_services_import_boundary_compliance(self):
        ...
        **Validates: Requirements 3.4**
        ...
        if all_violations:
            ...
            pytest.fail(f"Found {len(all_violations)} import boundary violations:\n{violation_report}")
