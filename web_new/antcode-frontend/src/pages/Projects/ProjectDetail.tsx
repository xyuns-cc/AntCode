...
import { Card, Descriptions, Tag, Button, Space, Spin, Typography, Collapse, Tooltip } from 'antd'
        ...
        <Collapse 
          ...
          items={[
            ...(project.rule_info.callback_type === 'mixed' ? [
              ...
              {
                key: 'detail',
                label: `详情页规则 (${detailRules.length})`,
                children: (
                  <ResponsiveTable 
                    columns={columns}
              ...
              {
                key: 'all',
                label: `提取规则 (${extractionRules.length})`,
                children: (
                  <ResponsiveTable 
                    columns={columns}
  ...
  return (
    <>
      <div>
        ...
        {/* 运行时信息 */}
        <Card title="运行时信息" style={{ marginTop: 16 }}>
