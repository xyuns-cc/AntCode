...
from antcode_web_api.routes.v1.log_stream import router as log_stream_router
...
from antcode_web_api.routes.v1.repositories import router as repositories_router
...
v1_router.include_router(log_stream_router, prefix="/logs", tags=["日志管理"])
...
v1_router.include_router(worker_install_router, prefix="/workers", tags=["Worker 管理"])
